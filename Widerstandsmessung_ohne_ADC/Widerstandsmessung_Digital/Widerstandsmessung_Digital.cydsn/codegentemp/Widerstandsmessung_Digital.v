...
module ADC_SAR_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("0b5d01a0-e2f9-4bdb-ad81-b841b8c1f742/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0b5d01a0-e2f9-4bdb-ad81-b841b8c1f742/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("6dc7acde-840a-4ca2-b13d-41c3f3e4d076"),
		  .drive_mode(3'b101),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("39537324-7e30-4464-868c-264eec242e9f"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__P_discharge_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__P_sense_net;
	wire [0:0] tmpIO_0__P_sense_net;
	wire [0:0] tmpINTERRUPT_0__P_sense_net;
	electrical [0:0] tmpSIOVREF__P_sense_net;

	cy_psoc3_pins_v1_10
		#(.id("fe7729a1-9c7b-4e72-9a22-a54d5d36fc72"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__P_sense_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__P_adc_net;
	wire [0:0] tmpFB_0__P_adc_net;
	wire [0:0] tmpIO_0__P_adc_net;
	wire [0:0] tmpINTERRUPT_0__P_adc_net;
	electrical [0:0] tmpSIOVREF__P_adc_net;
	...
	cy_psoc3_pins_v1_10
		...
		P_adc
		 (.oe(tmpOE__P_adc_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__P_adc_net[0:0]}),
		  .analog({Net_28}),
		  .io({tmpIO_0__P_adc_net[0:0]}),
		  .siovref(tmpSIOVREF__P_adc_net),
		  .interrupt({tmpINTERRUPT_0__P_adc_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),

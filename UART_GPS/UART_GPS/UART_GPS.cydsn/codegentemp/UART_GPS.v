// ======================================================================
// UART_GPS.v generated from TopDesign.cysch
// 01/27/2022 at 19:34
...
module UART_v2_50_1 (
	...
	cy_clock_v1_0
		#(.id("95cc9485-72ca-4743-9939-c7ba51bb376b/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
    ...
    defparam UART_gps.TXEnable = 0;

	wire [0:0] tmpOE__kitprog_tx_net;
	wire [0:0] tmpFB_0__kitprog_tx_net;
	wire [0:0] tmpIO_0__kitprog_tx_net;
	wire [0:0] tmpINTERRUPT_0__kitprog_tx_net;
	electrical [0:0] tmpSIOVREF__kitprog_tx_net;
	...
	cy_psoc3_pins_v1_10
		...
		kitprog_tx
		 (.oe(tmpOE__kitprog_tx_net),
		  .y({Net_54}),
		  .fb({tmpFB_0__kitprog_tx_net[0:0]}),
		  .io({tmpIO_0__kitprog_tx_net[0:0]}),
		  .siovref(tmpSIOVREF__kitprog_tx_net),
		  .interrupt({tmpINTERRUPT_0__kitprog_tx_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__kitprog_tx_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

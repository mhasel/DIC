// ======================================================================
// Helligkeitsmessung_LED.v generated from TopDesign.cysch
// 08/31/2021 at 04:15
...
module top ;
	...
	wire [0:0] tmpOE__Sensor_Pin_net;
	wire [0:0] tmpFB_0__Sensor_Pin_net;
	wire [0:0] tmpIO_0__Sensor_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Sensor_Pin_net;
	electrical [0:0] tmpSIOVREF__Sensor_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Sensor_Pin
		 (.oe(tmpOE__Sensor_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Sensor_Pin_net[0:0]}),
		  .io({tmpIO_0__Sensor_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Sensor_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Sensor_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sensor_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

...
*
* \funcusage
*  \snippet Sensor_Pin_SUT.c usage_Sensor_Pin_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Sensor_Pin_SUT.c usage_Sensor_Pin_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Sensor_Pin_SUT.c usage_Sensor_Pin_Read  
*******************************************************************************/
...
* preferred Sensor_Pin_Read() API because the 
* Sensor_Pin_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Sensor_Pin_SUT.c usage_Sensor_Pin_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Sensor_Pin_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Sensor_Pin_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Sensor_Pin_0_INTR       (First pin in the list)
    *  - Sensor_Pin_1_INTR       (Second pin in the list)
    *  - ...
    *  - Sensor_Pin_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Sensor_Pin_SUT.c usage_Sensor_Pin_SetInterruptMode
    *******************************************************************************/
    void Sensor_Pin_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Sensor_Pin_0_INTR) != 0u) 
		{ 
			 Sensor_Pin_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Sensor_Pin_SUT.c usage_Sensor_Pin_ClearInterrupt
    *******************************************************************************/

...
{
    uint8 staticBits = (AnalogIN_DR & (uint8)(~AnalogIN_MASK));
    AnalogIN_DR = staticBits | ((uint8)(value << AnalogIN_SHIFT) & AnalogIN_MASK);
}
...
{
	CyPins_SetPinDriveMode(AnalogIN_0, mode);
}
...
{
    return (AnalogIN_PS & AnalogIN_MASK) >> AnalogIN_SHIFT;
}
...
{
    return (AnalogIN_DR & AnalogIN_MASK) >> AnalogIN_SHIFT;
}
...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		if((position & AnalogIN_0_INTR) != 0u) 
		{ 
			 AnalogIN_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (AnalogIN_INTSTAT & AnalogIN_MASK) >> AnalogIN_SHIFT;
    }
